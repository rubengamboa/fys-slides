...
```{r matters-poll, echo=FALSE,fig.width=12}

counts = c(0,5,0,1,1,3,0,0,4,3)
labels = c("Television", "Internet", "Musicals", "Plumbing", "Gasoline", "Medicine", "NFL", "Games", "Art", "Outdoors")

barplot(height=counts, names.arg=labels)
