...
* Duplicate the image, so you have one that points left and one that points right

* Edit one the images by right-clicking on the image under the *Costumes* tab in the center region
